...
// doctor_darwin.go — macOS doctor Action body. Drives the full brew-based
// setup flow: pre-flight + identity, Homebrew install offer, Brewfile
// resolution, tool install, and outdated package upgrade.
