...
// Book is a top-level learn category shown in the book picker.
type Book struct {
...
// Books is the registry of all learn books. Learn is for general
// CLI/terminal/language tutorials — sci-specific command demos live
// under `sci help` instead.
var Books = []Book{
...
// Entry holds a single learn item — a terminal command demo, a markdown page,
...
// BasicEntries is the full list of basic terminal learn items.
