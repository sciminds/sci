// Package compose provides declarative layout composition utilities built on
// lipgloss. It depends only on lipgloss and ansi — no project-specific imports
// — so both standalone TUIs (dbtui) and the main sci UI can share it.
package compose
